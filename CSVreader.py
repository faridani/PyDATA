...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>dataTools/CSVreader.py at master from faridani's PyNLP - GitHub</title>
...
<script type="text/javascript">
  ...
  <div class="envelope commit">
    ...
    <div id="path">
      <b><a href="/faridani/PyNLP/tree/master">PyNLP</a></b> / <a href="/faridani/PyNLP/tree/master/dataTools">dataTools</a> / CSVreader.py       <span style="display:none" id="clippy_3638">dataTools/CSVreader.py</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_3638&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="http://assets0.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_3638&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
      ...
      <div class="file">
        <div class="meta">
          ...
          <ul class="actions">
              ...
              <li><a id="file-edit-link" href="#" rel="/faridani/PyNLP/file-edit/__ref__/dataTools/CSVreader.py">edit</a></li>
            
            <li><a href="/faridani/PyNLP/raw/master/dataTools/CSVreader.py" id="raw-url">raw</a></li>
            
              <li><a href="/faridani/PyNLP/blame/master/dataTools/CSVreader.py">blame</a></li>
            
            <li><a href="/faridani/PyNLP/commits/master/dataTools/CSVreader.py">history</a></li>
          </ul>
        </div>
...
<span id="LID9" rel="#L9">9</span>
          ...
          <td width="100%">
              ...
              <div class="highlight"><pre><div class='line' id='LC1'><span class="c">#</span></div><div class='line' id='LC2'><span class="c"># TODO</span></div><div class='line' id='LC3'><span class="c"># See: http://docs.python.org/library/csv.html</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="kn">import</span> <span class="nn">csv</span></div><div class='line' id='LC6'><span class="n">spamReader</span> <span class="o">=</span> <span class="n">csv</span><span class="o">.</span><span class="n">reader</span><span class="p">(</span><span class="nb">open</span><span class="p">(</span><span class="s">&#39;eggs.csv&#39;</span><span class="p">),</span> <span class="n">delimiter</span><span class="o">=</span><span class="s">&#39; &#39;</span><span class="p">,</span> <span class="n">quotechar</span><span class="o">=</span><span class="s">&#39;|&#39;</span><span class="p">)</span></div><div class='line' id='LC7'><span class="k">for</span> <span class="n">row</span> <span class="ow">in</span> <span class="n">spamReader</span><span class="p">:</span></div><div class='line' id='LC8'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">print</span> <span class="s">&#39;, &#39;</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">row</span><span class="p">)</span></div><div class='line' id='LC9'><br/></div></pre></div>
      ...
      <div class="site">
        <div class="info">
          <div class="links">
            ...
            <a href="http://support.github.com?sso=Z_ljhlotGAqY31J2PxuR1eRFDIRlObrJ6Gy43kqT_DiI3_gIDVhsYzkmMaMF49lT5YyfgdRxnjd_vz60hx31HtDEqFjOGI0nhFk2FjCagjBSt-xN83XmE6tBU3zwwa2761NfxbLTVOJMtRoq5Bjj5HZdyBG3DvbUtC9JN1rlUUZzX_5PBnfpZhfmzJNnUQBnhZ3Ffw3ku6DAHjyL4qGfUBEWpIFH3e8tFVJK5QHbDXQ">Support</a> |
          ...
          <div class="company">
            &copy;
            2010
            <span id="_rrt" title="0.22755s from fe2.rs.github.com">GitHub</span> Inc.
            All rights reserved. |
